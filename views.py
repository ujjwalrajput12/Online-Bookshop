...
def checkout_paypal(request,cart,orders):
    if request.user.is_authenticated():
        ...
        paypalrestsdk.configure({
            "mode":"sandbox",
            "client_id":"AWN90vKBqB1ioxWckehYAgORz04IpYmdl7IWPdZma3ViaMCbhiOavQLxXbOgrjn3aJFJ-hc5d-wvE_b0",
            "client_secret":"EDIBsCCFiLuVR6_2AtJ9lSvXqD2ndQ7FvSuKrqCHf0N-V6DOeFGqOLAPzbsGR27V8z0wLqg6t6q10o66", })
